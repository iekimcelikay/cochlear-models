...
normalized_tone = sound_gen.normalize_sound(tone)
...
sequence_params = [
    ...
    (100, 4, 0.033, 0.5, 5, 0.133), # Condition 4
...
# params = (100, 4, 0.133, 0.5, 5, 0.033)  # (freq, num_harmonics, tone_duration, harmonic_factor, total_duration, isi)
# sequence = sound_gen.generate_sequence(*params)
#
