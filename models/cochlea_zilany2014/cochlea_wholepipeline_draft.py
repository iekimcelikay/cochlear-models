...
from utils import (FolderCreator, FolderManager, LoggingConfigurator,
                   MetadataSaver, ResultSaver)  # noqa: E402
...
# dataclass for cochlea configuration (model parameters only)
@dataclass
class CochleaConfig:
...
@dataclass
class ToneConfig:
    """Configuration for tone stimulus generation."""
...
# Convenience function for population rate
