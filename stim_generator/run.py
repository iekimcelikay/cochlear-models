...
# Check out broadband filtered white noise
white_noise = sound_gen.noise_maker ()
...
# params =  (400, 4, 0.200, 0.5, 5, 0.133)  # (freq, num_harmonics, tone_duration, harmonic_factor, total_duration, isi)
# sequence = sound_gen.generate_sequence(*params)
#
