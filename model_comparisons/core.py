...
This module contains dataclasses that represent model
results and comparison configurations.
...
class RegressionResults:
    ...
    metadata: Dict = field(default_factory=dict)  # Additional info (std_err,
    # n_points, etc.)
